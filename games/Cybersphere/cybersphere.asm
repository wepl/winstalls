;*---------------------------------------------------------------------------
;  :Modul.	cybersphere.asm
;  :Contents.	Cybersphere
;  :Author.	Wepl
...
CHIPMEMSIZE	= $70000	;size of chip memory
FASTMEMSIZE	= $60000	;size of fast memory
...
_pl_program	PL_START
		PL_R	$9a		;getting vbr
		PL_IFC1				;cheat mode
		PL_W	$686a,1			;enable cheat flag, same as typing
